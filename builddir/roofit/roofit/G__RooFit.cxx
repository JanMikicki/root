...
namespace ROOT {
   static void *new_RooCrystalBall(void *p = 0);
   ...
   {
      ::RooCrystalBall *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::RooCrystalBall >(0);
      static ::ROOT::TGenericClassInfo 
   ...
   {
      return GenerateInitInstanceLocal((::RooCrystalBall*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::RooCrystalBall*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr RooCrystalBall::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::RooCrystalBall*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int RooCrystalBall::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::RooCrystalBall*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *RooCrystalBall::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooCrystalBall*)0x0)->GetClass();
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooCrystalBall*)0x0)->GetClass(); }
   return fgIsA;
}
