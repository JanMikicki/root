...
set(LLVM_BUILD_BINARY_DIR "/home/diagoras/root_cern/root/builddir/interpreter/llvm/src")
set(LLVM_BUILD_LIBRARY_DIR "/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/./lib")
set(LLVM_BUILD_MAIN_INCLUDE_DIR "/home/diagoras/root_cern/root/interpreter/llvm/src/include")
set(LLVM_BUILD_MAIN_SRC_DIR "/home/diagoras/root_cern/root/interpreter/llvm/src")
...
set(LLVM_INCLUDE_DIRS "/home/diagoras/root_cern/root/interpreter/llvm/src/include;/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/include")
set(LLVM_LIBRARY_DIRS "/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/./lib")
...
# them split.
set(LLVM_INCLUDE_DIR "/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/include")
set(LLVM_MAIN_INCLUDE_DIR "/home/diagoras/root_cern/root/interpreter/llvm/src/include")
set(LLVM_LIBRARY_DIR "/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/./lib")

set(LLVM_DEFINITIONS "")
set(LLVM_CMAKE_DIR "/home/diagoras/root_cern/root/interpreter/llvm/src/cmake/modules")
set(LLVM_BINARY_DIR "/home/diagoras/root_cern/root/builddir/interpreter/llvm/src")
set(LLVM_TOOLS_BINARY_DIR "/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/./bin")
set(LLVM_TOOLS_INSTALL_DIR "bin")
set(LLVM_HAVE_OPT_VIEWER_MODULES 0)
set(LLVM_CONFIGURATION_TYPES )

if(NOT TARGET LLVMSupport)
  set(LLVM_EXPORTED_TARGETS "LLVMDemangle;LLVMSupport;LLVMTableGen;llvm-tblgen;LLVMCore;LLVMFuzzMutate;LLVMIRReader;LLVMCodeGen;LLVMSelectionDAG;LLVMAsmPrinter;LLVMMIRParser;LLVMGlobalISel;LLVMBinaryFormat;LLVMBitReader;LLVMBitWriter;LLVMBitstreamReader;LLVMTransformUtils;LLVMInstrumentation;LLVMAggressiveInstCombine;LLVMInstCombine;LLVMScalarOpts;LLVMipo;LLVMVectorize;LLVMObjCARCOpts;LLVMCoroutines;LLVMLinker;LLVMAnalysis;LLVMLTO;LLVMMC;LLVMMCParser;LLVMMCDisassembler;LLVMMCA;LLVMObject;LLVMObjectYAML;LLVMOption;LLVMRemarks;LLVMDebugInfoDWARF;LLVMDebugInfoGSYM;LLVMDebugInfoMSF;LLVMDebugInfoCodeView;LLVMDebugInfoPDB;LLVMSymbolize;LLVMExecutionEngine;LLVMInterpreter;LLVMJITLink;LLVMMCJIT;LLVMOrcJIT;LLVMRuntimeDyld;LLVMTarget;LLVMX86CodeGen;LLVMX86AsmParser;LLVMX86Disassembler;LLVMX86Desc;LLVMX86Info;LLVMX86Utils;LLVMNVPTXCodeGen;LLVMNVPTXDesc;LLVMNVPTXInfo;LLVMAsmParser;LLVMLineEditor;LLVMProfileData;LLVMCoverage;LLVMPasses;LLVMTextAPI;LLVMDlltoolDriver;LLVMLibDriver;LLVMXRay;LLVMWindowsManifest;LTO;clang-tblgen;Remarks;LLVMHello;FileCheck;llvm-PerfectShuffle;count;not;yaml-bench;lli-child-target")
  include("/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/lib/cmake/llvm/LLVMExports.cmake")
  include("/home/diagoras/root_cern/root/builddir/interpreter/llvm/src/lib/cmake/llvm/LLVMBuildTreeOnlyTargets.cmake")
endif()
