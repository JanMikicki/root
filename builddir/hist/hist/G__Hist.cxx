...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TBinIterator*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TBinIterator*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *TBinIterator_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::TBinIterator*)0x0)->GetClass();
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::THistRange*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::THistRange*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *THistRange_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::THistRange*)0x0)->GetClass();
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TKDE*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TKDE", ::TKDE::Class_Version(), "TKDE.h", 34,
