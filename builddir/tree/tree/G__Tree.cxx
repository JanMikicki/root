...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TTreeFriendLeafIter*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TTreeFriendLeafIter", ::TTreeFriendLeafIter::Class_Version(), "TTree.h", 663,
...
namespace ROOT {
   static void *new_TLeafG(void *p = 0);
   ...
   {
      ::TLeafG *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TLeafG >(0);
      static ::ROOT::TGenericClassInfo 
   ...
   {
      return GenerateInitInstanceLocal((::TLeafG*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TLeafG*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr TLeafG::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TLeafG*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TLeafG::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TLeafG*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *TLeafG::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TLeafG*)0x0)->GetClass();
   return fgIsA;
}
...
TClass *TLeafG::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TLeafG*)0x0)->GetClass(); }
   return fgIsA;
}
