...
set(stdout_log "/home/diagoras/root_cern/root/builddir/VDT-prefix/src/VDT-stamp/VDT-install-out.log")
set(stderr_log "/home/diagoras/root_cern/root/builddir/VDT-prefix/src/VDT-stamp/VDT-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/diagoras/root_cern/root/builddir/VDT-prefix/src/VDT-stamp/VDT-install-*.log")
  endif()
  ...
  set(msg "VDT install command succeeded.  See also /home/diagoras/root_cern/root/builddir/VDT-prefix/src/VDT-stamp/VDT-install-*.log")
  message(STATUS "${msg}")
endif()
