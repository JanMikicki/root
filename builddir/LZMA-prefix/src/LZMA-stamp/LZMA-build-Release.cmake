...
set(stdout_log "/home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-build-out.log")
set(stderr_log "/home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-build-*.log")
  endif()
  ...
  set(msg "LZMA build command succeeded.  See also /home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-build-*.log")
  message(STATUS "${msg}")
endif()
