...
set(stdout_log "/home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-install-out.log")
set(stderr_log "/home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-install-*.log")
  endif()
  ...
  set(msg "LZMA install command succeeded.  See also /home/diagoras/root_cern/root/builddir/LZMA-prefix/src/LZMA-stamp/LZMA-install-*.log")
  message(STATUS "${msg}")
endif()
